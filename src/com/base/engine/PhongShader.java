...
public class PhongShader extends Shader{
    ...
    public static void setPointLights(PointLight[] pointLights) {
        if (pointLights.length > MAX_POINT_LIGHTS) {
            System.out.println("Error: You passed in too many point lights. " +
                    "Max allowed is " + MAX_POINT_LIGHTS + "." +
    ...
    public static void setSpotLights(SpotLight[] spotLights) {
        if (spotLights.length > MAX_SPOT_LIGHTS) {
            System.out.println("Error: You passed in too many spot lights. " +
